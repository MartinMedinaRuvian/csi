const TipoGabinete = require('../modelo/TipoGabinete')
const conexion = require('../util/conexion_mysql')

const nombreTabla = 'tipo_gabinete'
const idPropiedad = 'id'

class TipoGabineteDAO {
    ...
    async guardar(dato) {
        ...
        const datoGuardar = new TipoGabinete(descripcion.toUpperCase(), fecha_creacion, null, estado)
    ...
    async actualizar(dato) {
        console.log(dato)
        const generarQueryActualizarDB = new GenerarQueryActualizarDB(dato, nombreTabla, idPropiedad, TipoGabinete)
...
module.exports = TipoGabineteDAO