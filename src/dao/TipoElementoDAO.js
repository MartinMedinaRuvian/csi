const TipoElemento = require('../modelo/TipoElemento')
const conexion = require('../util/conexion_mysql')

const nombreTabla = 'tipo_elemento'
const idPropiedad = 'id'

class TipoElementoDAO {
    ...
    async guardar(dato) {
        ...
        const datoGuardar = new TipoElemento(descripcion.toUpperCase(), fecha_creacion, null, estado)
    ...
    async actualizar(dato) {
        console.log(dato)
        const generarQueryActualizarDB = new GenerarQueryActualizarDB(dato, nombreTabla, idPropiedad, TipoElemento)
...
module.exports = TipoElementoDAO